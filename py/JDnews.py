...
def get_page_url(maxpage):
    base_url = 'http://search.caixin.com/search/search.jsp?special=false&keyword=京东&channel=0&type=2&sort=1&time=&startDate=&endDate=&page='
    page_url = []
...
if __name__ == '__main__':
    ...
    df.to_csv("JDnews.csv", mode='a', index=False, sep=',', encoding='utf_8_sig')
