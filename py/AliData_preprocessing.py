...
if __name__ == '__main__':
    with open('/Users/liuyu/spider/Alibabanews.csv') as csvfile:
    ...
    datelist = get_datelist('20170523', '20180521')
    # Change the date of weekend to the day of following Monday
    datelist.reverse()
    ...
    final_date = news_detail['date']
    final_article = news_detail['article']

    news_df = news_prcessing(new_datelist, final_date, final_article)

    news_df.to_csv("Alidata_processing.csv", mode='a', index=False, sep=',', encoding='utf_8_sig')
